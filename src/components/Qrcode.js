...
function Qrcode(props) {
    return (<>
        <div className={style.qrconteiner}>
            ...
            {props.width < 1000 &&(<img src="http://s2.glbimg.com/XtGquOjcsqtxmRFjvQsFv9oIqY0=/290x290/s.glbimg.com/jo/g1/f/original/2011/05/17/qrcode.jpg" width="300" height="300" alt="Qrcode"></img>)}
        </div>
    </>)
}
